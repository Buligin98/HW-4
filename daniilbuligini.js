...
//   }
//   alert( getAverageAge(data) );

// 2 problem

// function specificAge(info) {
//   return info.filter((value) => value.age > 20);
// }

// specificAge(data);

// console.log(specificAge(data));
// 3 problems
// function onlyMails() {
//   let email = data.map((data) => data.email + " ");
//   return email;
// }

// onlyMails();

// console.log(onlyMails());
// 4 problems
// function counter(info) {
//     let female = info.filter((value) => value.gender == "Female");
//     let male = info.filter((value) => value.gender == "Male");
//     let sum = female.length + male.length;
//     console.log(
//     female.length +
//     " female user " +
//     male.length +
...
//     counter(data);
// 5 problems
// function firstUser(info) {
//   return info.find((value) => value.age > 40);
// }

// firstUser(data);

// console.log(firstUser(data));
// 6 problems
// function firstFive(info) {
//   let users = info.slice(0, 5);
//   console.log(users);
//   return users;
// }
...
// firstFive(data);
// 7 problems
// function search(info, name) {
//   let user = info.find((item) => item.firstname === name);
//   return user ? info.indexOf(user) : -1;
// }

// console.log(search(data, "Corny"));
